...
transform = transforms.Compose(
    [transforms.ToTensor(), transforms.Normalize((mean_gray,), (stddev_gray,))]
)
training_data = datasets.MNIST(
    root="C://", train=True, download=False, transform=transform
)
testing_data = datasets.MNIST(
    root="C://", train=False, download=False, transform=transform
)
...
print(
    f"PRINT AS many batches as there are {iteration}"
)  # that should print a number close to 600
