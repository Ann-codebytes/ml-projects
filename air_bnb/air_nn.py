...
data_in = data[['rating','price','country','bathrooms','beds','guests','bedrooms','studios']]
data_out = data['price']
...
data_in , data_test_in, data_out, data_test_out = train_test_split(data_in_original,data_out_original,test_size=0.3,random_state=0)
...
air_data_set_test_loader = torch.utils.data.DataLoader(air_data_set_test,shuffle=True,batch_size=32)
