...
=========================
Include conf/extra/binary_sentiment_analysis_proxy.conf



B. binary_sentiment_analysis_proxy.conf in the Apache/conf/extra path --> change as follows
---------------------------------------------------------------------- 
...
OR
Open a command prompt - >  navigate to  D:\ann_app_dev_ogph\binary_sentiment_app\server -> activate the venv
...
Activate the venv
Execute:
curl -X POST "http://127.0.0.1:8000/sentiment" -H "Content-Type: application/json" -d "{\"text\": \"Happy day\"}"
